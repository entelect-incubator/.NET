...
Create Data DTO's that we will use in the MVC Project for SOLID principal. Only send in data that is needed. Copy from Phase 3\Data\DTO\Data

![Data DTO's](2020-12-24-00-08-22.png)

You will see in any Data DTO, nullable boolean needs an extra property. Otherwise MVC doesn't know how to render it correctly.

Copy MimeTypes.cs from Phase 3\Data\Models

![MimeTypes.cs](2020-12-24-00-11-38.png)

Copy the Controllers from Phase 3\Data\Pezza.Api into Pezza.Api. This is using the new Data DTO's.
