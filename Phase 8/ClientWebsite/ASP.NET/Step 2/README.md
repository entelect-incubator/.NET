...
# &nbsp;**E List - Phase 7 - Dashboard - MVC - Step 2** [![.NET - Phase 7 - Dashboard - MVC - Step 2](https://github.com/entelect-incubator/.NET/actions/workflows/dotnet-phase7-dashboard-mvc-step2.yml/badge.svg)](https://github.com/entelect-incubator/.NET/actions/workflows/dotnet-phase7-dashboard-mvc-step2.yml)
...
ApiCallHelper in EList>portal change GetListAsync to use ListOutcome<T>
...
<div class="row">
	...
	<div class="col-6 text-right"><span id="CountData">0</span> Customers</div>
</div>
<br />
```
...
@Html.HiddenFor(model => model.Limit) @Html.HiddenFor(model => model.Page)
```
			...
			if (result) {
				...
				if (!result.data) {
					...
					for (var i = 0; i < result.data.length; i++) {
						...
						tableBody +=
							`<td align="right">
                        <a rel="tooltip" class="btn btn-info btn-sm btn-round btn-icon edit" href="/Customer/Edit/` +
							customer.id +
							`">
                        ...
                        <button onclick="remove(` +
							...
							`, '` +
							customer.name +
							`')" type="button" rel="tooltip" class="btn btn-danger btn-sm btn-round btn-icon remove">
				...
				if (result.data.length == 0) {
					...
					for (var i = 0; i < result.data.length; i++) {
						...
						cardBody +=
                            ...
                            <a rel="tooltip" class="btn btn-info btn-sm edit" href="/Restaurant/Edit/` +
							entity.id +
							`">
                                <i class="fa fa-wrench" aria-hidden="true"></i>
                                </a>
							...
							`, '` +
							entity.name +
							`')" type="button" rel="tooltip" class="btn btn-danger btn-sm remove">
                                <i class="fa fa-times" aria-hidden="true"></i>
                            </button>
                        </div>`;
						cardBody += "</div>";
