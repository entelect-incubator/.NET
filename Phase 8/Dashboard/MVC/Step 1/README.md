...
# &nbsp;**E List - Phase 8 - Portal - MVC - Step 1** [![.NET - Phase 8 - Dashboard - MVC - Step 1](https://github.com/entelect-incubator/.NET/actions/workflows/dotnet-phase8-dashboard-mvc-step1.yml/badge.svg)](https://github.com/entelect-incubator/.NET/actions/workflows/dotnet-phase8-dashboard-mvc-step1.yml)
...
A basic Portal for EList to manage all their pizza, products, orders, clients and restaurant data using MVC.

### **Create a new MVC project**

-   [ ] Create a new Solution Folder - 00 UI
-   [ ] Create a new Web Application Project ![ASP.NET Web Application](Assets/2020-12-10-21-28-37.png) ![](./Assets/2023-07-23-21-01-09.png) ![Model-View-Controller](Assets/2020-12-10-21-31-09.png)
-   [ ] Copy the EList Branding Guide & Design System files found in [Download]()
...
<html lang="en">
	...
	<body data-bs-theme="dark" class="text-light" style="background-image: url(images/space-background-dark.jpg)">
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
			<div class="container">
				<img class="d-block mx-auto" src="./images/logo.png" alt="" height="120" />
		...
		<footer align="center" class="border-top footer text-muted">&copy; @DateTime.Now.Year - EList</footer>
...
In your _style.css_ add the end and before the media queries add the following:
...
In your Pages\Shared_Layout.cshtml bfore you import the site.js file add the following:
...
Create a partial view in Pages\Shared_Modals.cshtml. This will be used for confirmation popups.
				...
				<div class="row" id="confirmation-error" style="display:none">
					<div class="col-12">
						<div class="alert alert-warning alert-with-icon">
							...
							<span> <b> Error! - </b> Error occured </span>
						</div>
					</div>
				</div>
...
Add a new BaseController in the Controllers Folder
...
Move to Step 2 [Click Here](https://github.com/entelect-incubator/.NET/tree/master/Phase%207/Dashboard/MVC/Step%202)
