...
public class TestNotifyCore : QueryTestBase
{
    ...
    public async Task Init()
    {
        ...
        var sutCreate = new CreateNotifyCommandHandler(Context, Mapper());
    ...
    {
        var sutGet = new GetNotifyQueryHandler(Context, Mapper());
    ...
    {
        var sutGetAll = new GetNotifiesQueryHandler(Context, Mapper());
    ...
    {
        var sutUpdate = new UpdateNotifyCommandHandler(Context, Mapper());
    ...
    {
        var sutDelete = new DeleteNotifyCommandHandler(Context);
