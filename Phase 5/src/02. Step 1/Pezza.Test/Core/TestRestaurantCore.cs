...
public class TestRestaurantCore : QueryTestBase
{
    ...
    public async Task Init()
    {
        ...
        var sutCreate = new CreateRestaurantCommandHandler(Context, Mapper());
    ...
    {
        var sutGet = new GetRestaurantQueryHandler(Context, Mapper());
    ...
    {
        var sutGetAll = new GetRestaurantsQueryHandler(Context, Mapper(), this.CachingService);
    ...
    {
        var sutUpdate = new UpdateRestaurantCommandHandler(Context, Mapper());
    ...
    {
        var sutDelete = new DeleteRestaurantCommandHandler(Context);
