...
public sealed class DeletePizzaCommand : LiteBus.Commands.Abstractions.ICommand<Result>
{
	public int? Id { get; set; }
}

public sealed class DeletePizzaCommandHandler(DatabaseContext databaseContext) : LiteBus.Commands.Abstractions.ICommandHandler<DeletePizzaCommand, Result>
{
