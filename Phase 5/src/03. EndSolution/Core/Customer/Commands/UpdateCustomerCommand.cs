...
public sealed class UpdateCustomerCommand : LiteBus.Commands.Abstractions.ICommand<Result<CustomerModel>>
{
...
public sealed class UpdateCustomerCommandHandler(DatabaseContext databaseContext) : LiteBus.Commands.Abstractions.ICommandHandler<UpdateCustomerCommand, Result<CustomerModel>>
{
