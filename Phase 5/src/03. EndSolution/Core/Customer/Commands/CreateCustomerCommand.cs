...
public sealed class CreateCustomerCommand : LiteBus.Commands.Abstractions.ICommand<Result<CustomerModel>>
{
	public CreateCustomerModel? Data { get; set; }
}

public sealed class CreateCustomerCommandHandler(DatabaseContext databaseContext) : LiteBus.Commands.Abstractions.ICommandHandler<CreateCustomerCommand, Result<CustomerModel>>
{
