...
public class TestProductCore : QueryTestBase
{
    ...
    public async Task Init()
    {
        ...
        var sutCreate = new CreateProductCommandHandler(this.Context);
    ...
    {
        var sutGet = new GetProductQueryHandler(this.Context);
    ...
    {
        var sutGetAll = new GetProductsQueryHandler(this.Context);
    ...
    {
        var sutUpdate = new UpdateProductCommandHandler(this.Context);
