...
public sealed class UpdateRestaurantCommandHandler : ICommandHandler<UpdateRestaurantCommand, Result<RestaurantDTO>>
{
    ...
    public async Task<Result<RestaurantDTO>> HandleAsync(UpdateRestaurantCommand request, CancellationToken cancellationToken)
    {
