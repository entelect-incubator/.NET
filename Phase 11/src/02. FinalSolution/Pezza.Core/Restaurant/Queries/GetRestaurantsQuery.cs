...
public sealed class GetRestaurantsQuery : IQuery<ListResult<RestaurantDTO>>
{
    public RestaurantDTO Data { get; set; }
}

public sealed class GetRestaurantsQueryHandler : IQueryHandler<GetRestaurantsQuery, ListResult<RestaurantDTO>>
{
    ...
    public async Task<ListResult<RestaurantDTO>> HandleAsync(GetRestaurantsQuery request, CancellationToken cancellationToken)
    {
