...
public sealed class GetProductsQuery : IQuery<ListResult<ProductDTO>>
{
    public ProductDTO Data { get; set; }
}

public sealed class GetProductsQueryHandler : IQueryHandler<GetProductsQuery, ListResult<ProductDTO>>
{
    ...
    public async Task<ListResult<ProductDTO>> HandleAsync(GetProductsQuery request, CancellationToken cancellationToken)
    {
