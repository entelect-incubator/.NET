...
public class TestNotifyCore : QueryTestBase
{
    ...
    public async Task Init()
    {
        ...
        var sutCreate = new CreateNotifyCommandHandler(this.Context);
    ...
    {
        var sutGet = new GetNotifyQueryHandler(this.Context);
    ...
    {
        var sutGetAll = new GetNotifiesQueryHandler(this.Context);
    ...
    {
        var sutUpdate = new UpdateNotifyCommandHandler(this.Context);
