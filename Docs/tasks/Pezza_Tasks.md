...
## Status
- Todos created in internal task tracker.
...
- Run code spell checks and review naming; apply fixes in small, focused PRs.
...
- See `Docs/Memory/README.md` for doc review checklists, AI review prompts, and templates to keep docs aligned with code.
