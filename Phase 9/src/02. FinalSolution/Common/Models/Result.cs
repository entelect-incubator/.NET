...
public class Result<IEnumerable<T>>
{
    ...
    public static Result<IEnumerable<T>> Success(List<T> data, int count) => new Result<IEnumerable<T>>(true, data, count, new List<object> { });

    public static Result<IEnumerable<T>> Success(IEnumerable<T> data, int count) => new Result<IEnumerable<T>>(true, data, count, new List<object> { });

    public static Result<IEnumerable<T>> Failure(string error) => new Result<IEnumerable<T>>(false, error);

    public static Result<IEnumerable<T>> Failure(List<object> errors) => new Result<IEnumerable<T>>(false, errors);
}
